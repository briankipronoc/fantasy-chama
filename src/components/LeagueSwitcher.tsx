...
export default function LeagueSwitcher({ variant = 'header' }: LeagueSwitcherProps) {
    ...
    return (
        <div ref={dropdownRef} className={`relative ${isSidebar ? 'w-full' : ''}`}>
            ...
            {open && (
                isSidebar ? (
                    <div className="mt-2 w-full bg-[#090e13] border border-white/10 rounded-2xl shadow-xl overflow-hidden animate-in fade-in duration-150 p-1.5 space-y-1">
                        ...
                        <div className="pt-1.5 border-t border-white/5">
                            <button
                                ...
                                className="w-full py-2 px-2.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-[10.5px] font-bold text-gray-200 hover:text-white flex items-center justify-center gap-1.5 transition-all cursor-pointer active:scale-95"
                            >
                    ...
                    <div className="absolute top-full right-0 mt-2 w-64 bg-[#0f1720]/95 backdrop-blur-2xl border border-white/15 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] z-[250] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150">
