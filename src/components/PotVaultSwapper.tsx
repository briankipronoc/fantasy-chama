...
export default function PotVaultSwapper({ weeklyPot, seasonVault, weeklyRulesPercent, isStealthMode }: SwapperProps) {
    ...
    return (
        <div className="bg-gradient-to-br from-[#1c272c] to-[#11171a] border border-[#FBBF24]/30 rounded-[2rem] p-6 md:p-8 relative overflow-hidden shadow-[0_0_30px_rgba(251,191,36,0.08)] hover:border-[#FBBF24]/50 transition-colors w-full min-h-[220px] flex flex-col justify-center">
            ...
            <div className="relative z-10 transition-all duration-500" style={{ opacity: showWeeklyPot ? 1 : 0, position: showWeeklyPot ? 'relative' : 'absolute', pointerEvents: showWeeklyPot ? 'auto' : 'none' }}>
