                ...
                <div className="fc-sidebar-shell w-full h-full rounded-3xl border border-white/10 bg-[#0b1014]/85 backdrop-blur-xl p-5 flex flex-col relative overflow-hidden">
                    ...
                    <div className={clsx('mb-7 relative z-10 text-center')}>
                        <div className="flex items-center justify-between mb-3">
                            <button
                                ...
                                className="p-2 rounded-lg border border-white/10 bg-white/[0.03] hover:bg-white/[0.06] text-gray-400 hover:text-white transition-colors"
                        ...
                        {isSidebarCollapsed && (
                            <div className="pt-2 flex flex-col items-center gap-2">
                                <span className="inline-flex items-center justify-center w-8 h-8 rounded-xl border border-white/15 bg-white/[0.03]">
                                    <Trophy className="w-4.5 h-4.5 text-gray-400" />
                                </span>
                                <span className="text-[9px] font-black text-gray-500 uppercase tracking-widest">FC</span>
                            </div>
                        )}
                    </div>
                            ...
                            return (
                                <Link
                                    ...
                                    className={clsx(
                                        ...
                                        isActive
                                            ? 'fc-sidebar-link-active text-white border-white/15 bg-white/[0.05]'
                                ...
                                >
                                    <span className={clsx(
                                        ...
                                        isSidebarCollapsed ? 'h-11 w-11 border border-transparent text-gray-500 group-hover:text-white group-hover:bg-white/[0.03]' : 'h-8 w-8 border',
                                        !isSidebarCollapsed && isActive ? 'bg-white/[0.08] border-white/15 text-white' : '',
                                    ...
                                    {!isSidebarCollapsed && isActive && <span className="ml-2 h-2 w-2 rounded-full bg-slate-300" />}
                                </Link>
                            );
                        })}
                    </div>
                    ...
                    <div className="mt-auto pt-4 border-t border-white/10 relative z-10">
                        <button
                            onClick={logout}
                            className={clsx(
                                'w-full rounded-xl transition-all font-bold text-sm border border-red-500/35 bg-[#EF4444]/15 text-red-300 hover:bg-red-500/25',
